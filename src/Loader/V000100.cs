...
class LoaderV000100 : Loader {
    ...
    */
    ...
    public LoaderV000100(string name, BinaryReader reader) {
    ...
    public bool isFileChanged(string path) {
        string compareHash = Util.createFileHash(path);
    ...
    public static void save(Level level) {
        ...
        // MD5 Hash
        writer.Write(Util.createFileHash(Game.contentPath + level.name + ".png"));
